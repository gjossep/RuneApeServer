...
public class lottery {
	...
	public int prizeAmount = 25; //jackpot amount (in millions)
	public int entryPrice = 2; //price to enter lottery (in millions)
	...
	public void enterLottery(Client c) {
		if (checkEntriesCount(c) < maximumEntryTimes) {
			if (c.getItems().playerHasItem(995, entryPrice * 1000000)) {
				...
				c.sendMessage("You have been entered into the lottery, when the lottery fund reaches 25M a winner");
