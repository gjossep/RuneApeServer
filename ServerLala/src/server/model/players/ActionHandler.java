...
public class ActionHandler {
	...
	public void firstClickObject(int objectType, int obX, int obY) {
		...
		/*case 9398://deposit
	c.getPA().sendFrame126("The Bank of TrisidiaX - Deposit Box", 7421);
	...
	c.fishitem = -1;
		...
		case 2244:
			c.getPA().showInterface(26099);
				...
				c.getPA().sendFrame126("@or1@TrisidiaX points: @gre@"+c.pkPoints+"  ", 26113);
...
c.getPA().sendFrame126(""+c.dungPoints+"", 18071);
			...
			case 5030:
				...
				c.sendMessage("You currently have <col=255>" + c.pkPoints + "</col> TrisidiaX Points.");
			break;
			case 1294:
		...
		// end of hunter :)
			...
			break;
			case 3789:
				c.sendMessage("You currently have " + c.pkPoints + " TrisidiaX Points.");
			break;
			case 3788:
				c.getShops().openVoid();
			break;
