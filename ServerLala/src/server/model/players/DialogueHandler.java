	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 44:
			...
			break;
                ...
                case 185:
                        sendNpcChat4("Hello, im Lottie im in charge of TrisidiaX's Lottery.", "Entering costs 2 million gp but you could win up to", "25 million gp! you can enter up to 5 times per draw.", "Would you like to enter the lottery?", c.talkingNpc, "Lottie");
                        c.nextChat = 186;
                break;
                case 186:
