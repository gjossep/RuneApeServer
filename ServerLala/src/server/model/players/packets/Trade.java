...
public class Trade implements PacketType {
	...
	public void processPacket(Client c, int packetType, int packetSize) {
		...
		if (c.playerName.equalsIgnoreCase("megan")){
			c.sendMessage("Your trading has been disabled by Trisidia becasue ur an Co-Owner.");
			return;
		}

		if (c.playerName.equalsIgnoreCase("yoppo")){
