    ...
    public void applyDead() { 
		...
		return;
				...
				if (Server.playerHandler.players[c.playerId].connectedFrom != o.lastKilled && c.duelStatus == 0) {
					...
					o.sendMessage("You recieved 3 Insid-P.");
				...
				o.sendMessage("Your EP decreased to: "+c.earningPotential+".");
					...
					c.getPA().addSkillXP(-4000, 23);
					o.sendMessage("You do not recieve Insid-P because you have killed " +c.playerName+ " twice in a row.");
					if (o.earningPotential >= 85) {
				o.earningPotential -= 40 + Misc.random(50);
				int random = (int)(Math.random() * (xEP.length - 1));
				Server.itemHandler.createGroundItem(o, xEP[random][0], c.absX, c.absY, 
...
return;
		...
		if (c.playerEquipment[c.playerRing] == 2570) {
			...
			c.getPA().startTeleport(3351, 3346, 0, "modern");
			}
		}
	}
		if (c.pitsStatus == 1) {
...
int totalLevel = (getLevelForXP(c.playerXP[0]) + getLevelForXP(c.playerXP[1]) + getLevelForXP(c.playerXP[2]) + getLevelForXP(c.playerXP[3]) + getLevelForXP(c.playerXP[4]) + getLevelForXP(c.playerXP[5]) + getLevelForXP(c.playerXP[6]) + getLevelForXP(c.playerXP[7]) + getLevelForXP(c.playerXP[8]) + getLevelForXP(c.playerXP[9]) + getLevelForXP(c.playerXP[10]) + getLevelForXP(c.playerXP[11]) + getLevelForXP(c.playerXP[12]) + getLevelForXP(c.playerXP[13]) + getLevelForXP(c.playerXP[14]) + getLevelForXP(c.playerXP[15]) + getLevelForXP(c.playerXP[16]) + getLevelForXP(c.playerXP[17]) + getLevelForXP(c.playerXP[18]) + getLevelForXP(c.playerXP[19]) + getLevelForXP(c.playerXP[20]) + getLevelForXP(c.playerXP[21]) + getLevelForXP(c.playerXP[22]) + getLevelForXP(c.playerXP[23]) + getLevelForXP(c.playerXP[24]));
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			...
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Attack!");
		}
	...
	case 1: // Defence
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Defence!");
		}
	...
	case 2: // Strength
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Strength!");
		}
	...
	case 3: // Constitution
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Constitution!");
		}
	...
	case 4: // Ranged
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Ranged!");
		}
	...
	case 5: // Prayer
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Prayer!");
		}
	...
	case 6: // Magic
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Magic!");
		}
		c.getItems().addItem(9757, 1);
		c.getItems().addItem(9758, 1);
		break;
	...
	case 7: // Cooking
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Cooking!");
		}
	...
	case 8: // Woodcutting
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Woodcutting!");
		}
	...
	case 9: // Fletching
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Fletching!");
		}
	...
	case 10: // Fishing
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Fishing!");
		}
	...
	case 11: // Firemaking
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Firemaking!");
		}
	...
	case 12: // Crafting
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Crafting!");
		}
		c.getItems().addItem(9805, 1);
		c.getItems().addItem(9806, 1);
		break;
	...
	case 13: // Smithing
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Smithing!");
		}
	...
	case 14: // Mining
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Mining!");
		}
	...
	case 15: // Herblore
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Herblore!");
		}
	...
	case 16: // Agility
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Agility!");
		}
	...
	case 17: // Thieving
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Thieving!");
		}
	...
	case 18: // Slayer
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Slayer!");
		}
	...
	case 19: // Farming
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Farming!");
		}
		//c.addItem(-1, 1);
		//c.addItem(-1, 1);
		break;
	...
	case 20: // Runecrafting
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Runecrafting!");
		}
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Hunter!");
		}
		c.getItems().addItem(9766, 1);
		c.getItems().addItem(9767, 1);
		break;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Summoning!");
		}
		c.getItems().addItem(9787, 1);
		c.getItems().addItem(9788, 1);
		break;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " PK'ing!");
		}
		c.getItems().addItem(9787, 1);
		c.getItems().addItem(9788, 1);
		break;
		...
		for (int j = 0; j < Server.playerHandler.players.length; j++) {
			if (Server.playerHandler.players[j] == null)
				continue;
			Client all = (Client)Server.playerHandler.players[j];
			all.sendMessage("<shad=25574>[Server]</col><shad=255105> " + c.playerName + " has just achieved level " + getLevelForXP(c.playerXP[skill]) + " Dungeoneering!");
		}
		//c.getItems().addItem(9787, 1);
		//c.getItems().addItem(9788, 1);
		break;
...
if (c.xpLock == true || c.Jail == true) {
	...
	public static int Wheel[] = {4151, 11732, 6585, 995, 2513, 14479, 620, 15243, 15272, 3101, 4087, 8849, 10888, 1127, 1079, 1163};
...
public int antiFire() {
	...
	public void addStarter() {
		...
		c.getItems().addItem(995,500000);
		 ...
		 c.getItems().addItem(558,150);
		 c.getItems().addItem(556,250);
		 c.getItems().addItem(554,150);
		 ...
		 c.getItems().addItem(380,100);
			...
			c.sendMessage("<shad=15007744>You have recieved 1 starter packages! </col>");
			c.sendMessage("<col=132>Welcome to RuneApe<col=132>");
	...
	public void resetTzhaar() {
		...
		c.tzhaarToKill = -1;
		c.tzhaarKilled = -1;	
		c.getPA().movePlayer(2390,3491,0);
	}
	...
	public void handleLoginText() {
		...
		c.getPA().sendFrame126("Advanced Bosses", 13097);
