...
public class Config {
	...
	public static final String SERVER_NAME = "RuneApe";
	public static final String WELCOME_MESSAGE = "Welcome to RuneApe";
	public static final String FORUMS = "NO";
	...
	public static final int CONNECTION_DELAY = 500; // how long one ip can keep connecting
	...
	public static final int MELEE_EXP_RATE = 1600; // damage * exp rate
	...
	public static final int SAVE_TIMER = 1; // save every 1 minute
	...
	*/	
	...
	public static final int SMITHING_EXPERIENCE = 35;
