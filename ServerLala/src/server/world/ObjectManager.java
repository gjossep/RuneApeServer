...
//				
//			///Home Objects!	
//		c.getPA().checkObjectSpawn(411, 3336, 3342, 1, 10);   /// Choras Altar
//		c.getPA().checkObjectSpawn(4008, 3336, 3340, 1, 10);  ///Spec Attack Altar
//		c.getPA().checkObjectSpawn(6552, 3336, 3337, 1, 10);  ///Ancient Altar
//		c.getPA().checkObjectSpawn(409, 3345, 3343, -1, 10);  /// Altar
//		c.getPA().checkObjectSpawn(410, 3335, 3346, 1, 10);   ///Guthix Altar
//		c.getPA().checkObjectSpawn(2213, 2383, 3488, 1, 10);   /// Bank Booth
...
//
//		c.getPA().checkObjectSpawn(4874, 3343, 3333, 1, 10);///Home Stalls lvl 1
//		c.getPA().checkObjectSpawn(4875, 3344, 3333, 1, 10);///Home Stalls lvl 25
//		c.getPA().checkObjectSpawn(4876, 3345, 3333, 0, 10);///Home Stalls lvl 50
//		c.getPA().checkObjectSpawn(4877, 3346, 3333, 0, 10);///Home Stalls lvl 75
//		c.getPA().checkObjectSpawn(4878, 3347, 3333, 0, 10);///Home Stalls lvl 90
//
//		c.getPA().checkObjectSpawn(1596, 3008, 3850, 1, 0);
//		c.getPA().checkObjectSpawn(1596, 3008, 3849, -1, 0);
//		c.getPA().checkObjectSpawn(1596, 3040, 10307, -1, 0);
...
//		c.getPA().checkObjectSpawn(-1, 2841, 3443, -1, 10);
//		c.getPA().checkObjectSpawn(-1, 2851, 3438, -1, 10);
	//	c.getPA().checkObjectSpawn(5, 3182, 3429, 1, 10); //Donatorchest
