...
try {
	...
	ex.printStackTrace();
		...
		System.out.println("Launching RuneApe");
		...
		acceptor.bind(new InetSocketAddress(InetAddress.getByName(ipAdress),serverlistenerPort), connectionHandler, sac);
		 ...
		 */
		System.out.println("Server listening on port "+ipAdress+":" + serverlistenerPort);
		/**
		 * Main Server Tick
		 */
		try {
		...
		private static void redirectSystemStreams() {
		  OutputStream out = new OutputStream() {
		    ...
		    public void write(int b) throws IOException {
		      Screen.updateTextArea(String.valueOf((char) b));
		    }
		 
		    @Override
		    public void write(byte[] b, int off, int len) throws IOException {
		      Screen.updateTextArea(new String(b, off, len));
		    }
